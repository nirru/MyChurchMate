...
public class PostJson {
	...
	public PostJson(String url, String appPin, String fName, String sName,
		...
		this.url = url;
		Log.e("MAY AYA DEVICE ID", "" + deviceIdFromGCMorAPNS);
		
//		Log.e("--TAG--", "clientid" + " " + appPin);
//		Log.e("--TAG--", "fName" + " " + fName);
//		Log.e("--TAG--", "sName" + " " + sName);
//		Log.e("--TAG--", "email" + " " + eMail);
//		Log.e("--TAG--", "password" + " " + passWord);
//		Log.e("--TAG--", "address_One" + " " + address_One);
//		Log.e("--TAG--", "address_Two" + " " + address_Two);
...
//		Log.e("--TAG--", "sex" + " " + sex);
//		Log.e("--TAG--", "physicalDeviceId" + " " + physicalDeviceId);
//		Log.e("--TAG--", "homeTelephone" + " " + homeTelephone);
//		Log.e("--TAG--", "deviceOS" + " " + deviceOS);
//		Log.e("--TAG--", "deviceIdFromGCMorAPNS" + " " + deviceIdFromGCMorAPNS);
//		Log.e("--TAG--", "deviceType" + " " + deviceType);
//		Log.e("--TAG--", "churMemeberShip_ID" + " " + churMemeberShip_ID);
//		Log.e("--TAG--", "url" + " " + url);
